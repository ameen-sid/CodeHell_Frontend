...
import ImageOne from "../assets/Images/FoundingStory.png";
	...
	return (
		<main>
			...
			<section className="bg-richblack-700">
				<div className="relative mx-auto flex w-[1260px] flex-col justify-between gap-10 text-center text-white">
					<header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
						Driving Innovation in Online Education for a{" "}
						<HighlightText text={"Brighter Future"} />
						<p className="mx-auto mt-3 text-center text-base font-medium text-[#838894] lg:w-[95%]">
							CodeHell is at the forefront of driving innovation
							in online education. We're passionate about creating
			...
			{/* section 2 */}
			<section className="border-b border-richblack-700 mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
			...
			<section className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
				<article className="flex flex-col items-center gap-10 lg:flex-row justify-between">
					<aside className="my-24 flex lg:w-[50%] flex-col gap-10">
						<h4 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]">
							Our Founding Story
						</h4>
				...
				<article className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
					<aside className="my-24 flex lg:w-[40%] flex-col gap-10">
						<h4 className="bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]">
							Our Vision
						</h4>
						<p className="text-base font-medium text-richblack-300 lg:w-[95%]">
					...
					<aside className="my-24 flex lg:w-[40%] flex-col gap-10">
						<h4 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] text-transparent bg-clip-text text-4xl font-semibold lg:w-[70%]">
							Our Mission
						</h4>
						<p className="text-base font-medium text-richblack-300 lg:w-[95%]">
